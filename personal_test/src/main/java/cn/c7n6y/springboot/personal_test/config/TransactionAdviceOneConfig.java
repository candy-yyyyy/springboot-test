...
@Aspect
@Configuration
public class TransactionAdviceOneConfig {
    private static final String AOP_POINTCUT_EXPRESSION = "execution (* ccn.c7n6y.springboot.personal_test.service.*.*(..))";
    ...
    public TransactionInterceptor txAdvice1() {
        ...
        return new TransactionInterceptor(transactionManager1, source);
    }
