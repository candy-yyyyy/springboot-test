...
@Aspect
@Configuration
public class TransactionAdviceTwoConfig {
    private static final String AOP_POINTCUT_EXPRESSION = "execution (* cn.c7n6y.springboot.personal_test.service.*Serv*.*(..))";
    ...
    public TransactionInterceptor txAdvice2() {
        ...
        return new TransactionInterceptor(transactionManager2, source);
    }
